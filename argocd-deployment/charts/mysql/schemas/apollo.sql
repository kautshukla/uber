...
# Dump of table subscription_slots
# ------------------------------------------------------------
...
INSERT IGNORE INTO `org` (`id`, `name`, `email`, `is_active`, `is_on_subscription`, `org_github_url`, `modified_by`)
VALUES
    (1, 'dview', 'demo@dview.io', 1, 1, 'https://github.com/dview-io/k8-deployment', 'info@dview.io');
...
INSERT IGNORE INTO `tenant` (`id`, `org_id`, `name`, `email`, `is_active`, `description`)
VALUES
    (1, 1, 'analytics', 'demo@dview.io', 1, 'data-platform');

INSERT IGNORE INTO `users` (`id`, `email`, `name`, `phone`, `designation`, `purpose`, `registered`, `blacklisted`, `phone_verified`, `email_verified`, `password`, `role_id`, `org_id`, `on_trial`, `dinsights_enabled`, `persona_id`)
VALUES
    (1, 'demo@dview.io', 'Demo', '+919207404444', 'SDE', 'For demo', 1, 0, 0, 1, 'Nmd9tXbu/cAUrGYzN1X+2g==', 1, 1, 1, 1, 3);

INSERT IGNORE INTO `user_tenants` (`id`, `tenant_id`, `user_id`, `org_id`, `is_active`)
VALUES
    (1, 1, 1, 1, 1);
