...
CREATE TABLE IF NOT EXISTS `x_portal_user` (
...
CREATE TABLE IF NOT EXISTS `x_portal_user_role` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `added_by_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `xa_access_audit` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `added_by_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_asset` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `added_by_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_auth_sess` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `added_by_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_cred_store` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `added_by_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_db_base` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `added_by_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_group` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `added_by_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_group_groups` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `added_by_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_group_users` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `added_by_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_policy_export_audit` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `added_by_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_resource` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `added_by_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_trx_log_v2` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_time` datetime DEFAULT NULL,
  `added_by_id` bigint(20) DEFAULT NULL,
  ...
  KEY `x_trx_log_v2_trx_id` (`trx_id`(191))
)ROW_FORMAT=DYNAMIC;

CREATE TABLE IF NOT EXISTS `x_perm_map` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `added_by_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_audit_map` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `added_by_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_service_config_def` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(1024) DEFAULT NULL,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_resource_def` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(1024) DEFAULT NULL,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_access_type_def` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(1024) DEFAULT NULL,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_access_type_def_grants` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(1024) DEFAULT NULL,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_policy_condition_def` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(1024) DEFAULT NULL,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_context_enricher_def` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(1024) DEFAULT NULL,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_enum_def` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(1024) DEFAULT NULL,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_enum_element_def` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(1024) DEFAULT NULL,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_service_config_map` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(1024) DEFAULT NULL,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_policy_resource` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(1024) DEFAULT NULL,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_policy_resource_map` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(1024) DEFAULT NULL,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_policy_item` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(1024) DEFAULT NULL,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_policy_item_access` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(1024) DEFAULT NULL,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_policy_item_condition` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(1024) DEFAULT NULL,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_policy_item_user_perm` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(1024) DEFAULT NULL,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_policy_item_group_perm` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(1024) DEFAULT NULL,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_data_hist` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_modules_master` (
`id` bigint(20) NOT NULL AUTO_INCREMENT,
`create_time` datetime NULL DEFAULT NULL,
`update_time` datetime NULL DEFAULT NULL,
`added_by_id` bigint(20) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_user_module_perm` (
`id` bigint(20) NOT NULL AUTO_INCREMENT,
`user_id` bigint(20) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_group_module_perm` (
`id` bigint(20) NOT NULL AUTO_INCREMENT,
`group_id` bigint(20) NULL DEFAULT NULL,
`module_id` bigint(20) NULL DEFAULT NULL,
`create_time` datetime NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_datamask_type_def` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
...
CREATE TABLE IF NOT EXISTS `x_policy_item_datamask` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(64) NULL DEFAULT NULL,
`create_time` datetime NULL DEFAULT NULL,
`update_time` datetime NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_policy_item_rowfilter` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(64) NULL DEFAULT NULL,
`create_time` datetime NULL DEFAULT NULL,
`update_time` datetime NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_service_version_info` (
`id` bigint(20) NOT NULL AUTO_INCREMENT,
`service_id` bigint(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS  `x_policy_label` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(1024) DEFAULT NULL,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS  `x_policy_label_map` (
`id` bigint(20) NOT NULL AUTO_INCREMENT ,
`guid` varchar(1024) DEFAULT NULL,
`create_time` datetime DEFAULT NULL,
`update_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_rms_service_resource` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `guid` varchar(64) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `x_rms_notification` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `x_rms_resource_mapping` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `change_timestamp` timestamp NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_rms_mapping_provider` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `change_timestamp` timestamp NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `x_gds_dataset` (
    `id`                BIGINT(20)   NOT NULL AUTO_INCREMENT
  , `guid`              VARCHAR(64)  NOT NULL
  , `create_time`       TIMESTAMP    NULL     DEFAULT NULL
  , `update_time`       TIMESTAMP    NULL     DEFAULT NULL
...
CREATE TABLE IF NOT EXISTS `x_gds_project` (
    `id`              BIGINT(20)   NOT NULL AUTO_INCREMENT
  , `guid`            VARCHAR(64)  NOT NULL
  , `create_time`     TIMESTAMP    NULL     DEFAULT NULL
  , `update_time`     TIMESTAMP    NULL     DEFAULT NULL
...
CREATE TABLE IF NOT EXISTS `x_gds_data_share`(
    `id`                   BIGINT(20)   NOT NULL AUTO_INCREMENT
  , `guid`                 VARCHAR(64)  NOT NULL
  , `create_time`          TIMESTAMP    NULL     DEFAULT NULL
  , `update_time`          TIMESTAMP    NULL     DEFAULT NULL
...
CREATE TABLE IF NOT EXISTS `x_gds_shared_resource`(
    `id`                   BIGINT(20)   NOT NULL AUTO_INCREMENT
  , `guid`                 VARCHAR(64)  NOT NULL
  , `create_time`          TIMESTAMP    NULL     DEFAULT NULL
  , `update_time`          TIMESTAMP    NULL     DEFAULT NULL
...
CREATE TABLE IF NOT EXISTS `x_gds_data_share_in_dataset`(
    `id`                   BIGINT(20)   NOT NULL AUTO_INCREMENT
  , `guid`                 VARCHAR(64)  NOT NULL
  , `create_time`          TIMESTAMP    NULL     DEFAULT NULL
  , `update_time`          TIMESTAMP    NULL     DEFAULT NULL
...
CREATE TABLE IF NOT EXISTS `x_gds_dataset_in_project`(
    `id`                   BIGINT(20)   NOT NULL AUTO_INCREMENT
  , `guid`                 VARCHAR(64)  NOT NULL
  , `create_time`          TIMESTAMP    NULL     DEFAULT NULL
  , `update_time`          TIMESTAMP    NULL     DEFAULT NULL
...
CREATE TABLE IF NOT EXISTS `x_gds_dataset_policy_map`(
    `id`         BIGINT(20) NOT NULL AUTO_INCREMENT
  , `dataset_id` BIGINT(20) NOT NULL
  , `policy_id`  BIGINT(20) NOT NULL
  , PRIMARY KEY(`id`)
...
CREATE TABLE IF NOT EXISTS `x_gds_project_policy_map`(
    `id`         BIGINT(20) NOT NULL AUTO_INCREMENT
  , `project_id` BIGINT(20) NOT NULL
  , `policy_id`  BIGINT(20) NOT NULL
  , PRIMARY KEY(`id`)
